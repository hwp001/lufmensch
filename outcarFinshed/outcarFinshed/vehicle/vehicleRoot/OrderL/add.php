...
<table class="table table-bordered table-hover definewidth m10">        <input style="width:120px;height: 23px;" type="hidden" name="orderId" value="<?php echo date('Ymd').rand(2,pow(3,10)); ?> " readonly/>
    <tr>      
...
?>
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="existState" value="1" checked/> 上架
            <input type="radio" name="existState" value="0"/> 下架
        </td>
    </tr>
