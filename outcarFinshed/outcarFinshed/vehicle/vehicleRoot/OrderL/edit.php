...
<table class="table table-bordered table-hover definewidth m10">     <input style="width:120px;height: 23px;" type="hidden" name="orderId" value="<?php echo $row['orderId']?>" readonly/>
    <tr>      
        <td  class="tableleft">&nbsp;&nbsp;&nbsp;订单号：</td>
        <td><input style="width:120px;height: 23px;" type="text" name="orderNum" value="<?php echo $row['orderNum']; ?> " /></td>
    </tr> 
    <tr>
...
?>
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="existState" value="1" <?php echo $check?>/> 上架
            <input type="radio" name="existState" value="0" <?php echo $checked?> /> 下架
        </td>
    </tr>
    <tr>
